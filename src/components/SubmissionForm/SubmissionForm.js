  ...
  render() {
    return (
      ...
      >
        ...
        <FormHeader>
          Let's get <GreenSpan>started</GreenSpan>
        </FormHeader>
        <FormBody>
          ...
          <FormField>
            ...
            <SubLabel>
              You can include here any info that will help me understand the
              project better. (E.g. present guidlines,sketches, thoughts, aims,
              whatever)
            </SubLabel>
          </FormField>
          <ButtonContainer>
